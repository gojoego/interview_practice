...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        // boolean that allows for continuous games
        ...
        while (doYouWantToPlay) {
            ...
            System.out.println("Welcome to Tic Tac Toe! You are about to go against " +
                    ...
                    "must ick what character you want to be and which character I will be");
            System.out.println();
            ...
            System.out.println();
            // set up a new game... or not depending on response
            System.out.println("Do you want to play again? Enter Y if you do. Enter " +
