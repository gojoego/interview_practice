...
For this exercise, we'll work with the
primitives used to hold integer values:
...
Each test case, T, is comprised of a single line with an integer, T,
...
print each one on its own line and order them by size
...
213333333333333333333333333333333333 is very large and is outside of
the allowable range of values for the primitive data types discussed in this problem.
